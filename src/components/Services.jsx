        ...
        {services.map((service, idx) => (
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-white text-2xl font-['El_Messiri'] font-semibold tracking-wide transform transition-all duration-700 md:group-hover:-translate-y-24 md:group-hover:scale-125">
                {service.title.toUpperCase()}
              </h3>
            </motion.div>

            {/* Hover Text */}
            <div className="absolute inset-0 z-[2] hidden md:flex flex-col items-center justify-center px-5 pt-5 text-center text-white opacity-0 transition-opacity duration-500 group-hover:opacity-100 group-hover:pointer-events-auto group-hover:delay-300">
              <motion.span
