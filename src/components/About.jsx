...
export default function About() {
  return (
    ...
    >
      ...
      {/* Title */}
      <motion.p
        className="relative z-10 block text-left px-6 my-8 md:absolute md:left-[100px] md:top-[92px] md:my-10 md:px-0 uppercase font-['El_Messiri'] font-semibold text-[16px] md:text-[24px] leading-[32px] md:leading-[38px] text-[#919AA0]"
      ...
      <div className="relative z-10 flex flex-col md:block items-start justify-center h-full mt-0">
        ...
        {/* Image */}
        <motion.div
          className="relative md:absolute w-[90%] mx-auto md:mx-0 md:w-[459.9px] h-[420px] md:h-[838.95px] md:left-[952.05px] md:translate-x-0 mt-10 md:mt-0 bottom-0"
