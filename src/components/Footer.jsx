    ...
    <footer className="bg-[#1D2428] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-80">
          {/* Logo */}
          <div className="flex flex-col text-center items-center md:items-start flex-1">
            <img src="/assets/sm-logo.png" alt="SM Studio Logo" className="w-20 mb-3" />
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex gap-6 justify-center md:justify-start">
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full border border-white/40 hover:border-white transition">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full border border-white/40 hover:border-white transition">
                <MessageCircle className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/smstudios.om/?hl=en" 
