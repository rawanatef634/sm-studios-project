        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 md:items-stretch md:min-h-[280px]">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <button
              ...
              className="mt-auto pt-10 p-1 text-gray-300 hover:text-white transition"
          ...
          <div className="text-center md:text-left flex flex-col">
            ...
            <p className="font-['El_Messiri'] text-sm text-gray-300 max-w-sm mx-auto md:mx-0 leading-relaxed">
          ...
          <div className="text-center md:text-left flex flex-col">
            ...
            <p className="mt-auto pt-10 font-['El_Messiri'] text-[11px] tracking-[0.12em] text-[#8b9199] text-center md:text-right">
